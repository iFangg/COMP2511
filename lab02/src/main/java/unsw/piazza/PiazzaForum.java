...
public class PiazzaForum {
    ...
    // public Thread publish(String title, String content, User author) {
        // Thread newThread = new Thread(author, title, content);
    ...
    //     ArrayList<Post> byAuthor = new ArrayList<Post>();
    //         for (Thread j: threads) {
    //             User postAuthor = j.getOwner();
    //             if (postAuthor.equals(author)) byAuthor.add(j);
    //         }
    //     return byAuthor;
